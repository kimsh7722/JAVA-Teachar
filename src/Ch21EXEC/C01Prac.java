	...
	public static void main(String[] args) throws Exception{
		...
		while (true) {
			...
			case 2:
				...
				subject=sc.next();
				//제목을 입력하면 해당 제목의 내용 출력되게 합니다.
				contents = map.get(subject).substring(4);	//null문자열자동들어감
				if(contents==null) {
					System.out.println("제목과 일치하는 내용이없습니다.");
				}
				else {
			...
			case 3:
				...
				//issue 3 파일명을 map 에 저장해야되는 문제 -> String아니라 Memo 클래스 생성
